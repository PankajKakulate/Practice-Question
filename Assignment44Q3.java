...
// Description   : write java program to accept directory name from user and write data of all files into newly created file named as "Marvellous.txt".
// input         : String,String
// output        : void
// Date          : 03/07/2022
